...
/////////////////////////////////////////
        ...
        background.src = 'krizovatky/kruhac.svg';

        background.onload = function(){
            ctx.drawImage(background,0,0,700,700);   
        };
        
        animateScript(1,size_canvas/2-50,size_canvas/2-370,90,0,"car1");
        animateScript(5,size_canvas/2-240,size_canvas/2-160,219,0,"car2");
        $('#car1').on("click",function(event) {
            goleft_down("car1",size_canvas/2-50,size_canvas/2-370,size_canvas/2-50,size_canvas/2-250);
            krizovatka.push("car1");
            $("#car1").off("click");});

        $('#car2').on("click",function(event) {
            goround_2("car2",size_canvas/2-240,size_canvas/2-160,230,0);
            krizovatka.push("car2");
            $("#car2").off("click");});
    }
        ...
        var background = new Image();
        background.src = 'krizovatky/krizovatka1.svg';

        background.onload = function(){
            ctx.drawImage(background,0,0,700,700);   
        };
        animateScript(1,size_canvas/2-45,size_canvas/2-350,90,0,"car1");
        animateScript(2,size_canvas/2+100,size_canvas/2-49,0,1,"car2");
        animateScript(3,size_canvas/2-155,size_canvas/2+90,-90,1,"car3");

        $('#car1').on("click",function(event) {
            gostraigh("car1",size_canvas/2-45,size_canvas/2-350, size_canvas/2-45, size_canvas+200);
            $("#car1").off("click");
            krizovatka.push("car1");
        });
        $('#car2').on("click",function(event) {
            godown_left("car2",size_canvas/2+100,size_canvas/2-49, size_canvas/2-60,size_canvas/2-50,);
            krizovatka.push("car2");
            $("#car2").off("click");
        });
        $('#car3').on("click",function(event) {
            goright_down("car3", size_canvas/2-155,size_canvas/2+90, size_canvas/2-155, size_canvas/2-60);
            krizovatka.push("car3");
            $("#car3").off("click");});
    }
        ...
        var background = new Image();
        background.src = 'krizovatky/krizovatka2.svg';

        background.onload = function(){
            ctx.drawImage(background,0,0,700,700);   
        };

        animateScript(2,size_canvas/2-300,size_canvas/2-240,180,1,"car1");
        animateScript(5,size_canvas/2+130,size_canvas/2-135,0,0,"car2");
        animateScript(4,size_canvas/2-155,size_canvas/2+90,-90,2,"car3");
        $('#car2').on("click",function(event) {
            gostraigh("car2", size_canvas/2+130,size_canvas/2-135, -200, size_canvas/2-135,);
            krizovatka.push("car2");
            $("#car2").off("click");
        });
        $('#car1').on("click",function(event) {
            goup_right("car1", size_canvas/2-300,size_canvas/2-240, size_canvas / 2-145, size_canvas/2-240);
            krizovatka.push("car1");
            $("#car1").off("click");});
        $('#car3').on("click",function(event) {
            goright_up("car3", size_canvas/2-155,size_canvas/2+90, size_canvas/2-155, size_canvas/2-50,);
            krizovatka.push("car3");
            $("#car3").off("click");
        });
    }
        ...
        var background = new Image();
        background.src = 'krizovatky/krizovatka3.svg';

        background.onload = function(){
            ctx.drawImage(background,0,0,700,700);   
        };

        animateScript(4,size_canvas/2-320,size_canvas/2-155,180,1,"car1");
        animateScript(1,size_canvas/2-45,size_canvas/2-340,90,0,"car2");
        animateScript(3,size_canvas/2-155,size_canvas/2+130,-90,1,"car3");
        $('#car2').on("click",function(event) {
            gostraigh("car2", size_canvas/2-45,size_canvas/2-340, size_canvas/2-45, size_canvas+200,);
            krizovatka.push("car2");
            $("#car2").off("click");
        });
        $('#car3').on("click",function(event) {
            goright_down("car3", size_canvas/2-155,size_canvas/2+130, size_canvas / 2-155, size_canvas/2-65);
            krizovatka.push("car3");
            $("#car3").off("click");});
        $('#car1').on("click",function(event) {
            goup_right("car1", size_canvas/2-320,size_canvas/2-155, size_canvas / 2-140, size_canvas/2-155);
            krizovatka.push("car1");
            $("#car1").off("click");});
    }
        ...
        var background = new Image();
        background.src = 'krizovatky/krizovatka4.svg';

        background.onload = function(){
            ctx.drawImage(background,0,0,700,700);   
        }

        animateScript(4,size_canvas/2-370,size_canvas/2-100,180,0,"car1");
        animateScript(1,size_canvas/2-92,size_canvas/2-340,90,0,"car2");
        animateScript(3,size_canvas/2+2,size_canvas/2-340,90,2,"car3");

        $('#car2').on("click",function(event) {
            gostraigh("car2", size_canvas/2-92,size_canvas/2-340, size_canvas/2-92, size_canvas+200,);
            krizovatka.push("car2");
            $("#car2").off("click");
        });
        $('#car1').on("click",function(event) {
            gostraigh("car1", size_canvas/2-370,size_canvas/2-100, size_canvas+250, size_canvas/2-100,);
            krizovatka.push("car1");
            $("#car1").off("click");
        });
        $('#car3').on("click",function(event) {
            goleft_down("car3",size_canvas/2+2,size_canvas/2-340,size_canvas/2+2,size_canvas/2-190);
            krizovatka.push("car3");
            $("#car3").off("click");});
    }
}
